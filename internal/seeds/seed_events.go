...
func SeedEvents(db *gorm.DB) {
	...
	events := []event.Event{
		...
		},
		{
			...
			Description:  "Pementasan seni drama tari legendaris kisah berdirinya seribu candi Roro Jonggrang dan Bandung Bondowoso. Digelar megah di panggung Trimurti dengan tata pencahayaan modern dramatis dan efek multimedia yang memukau.",
			Location:     "Panggung Trimurti Candi Prambanan, Sleman",
